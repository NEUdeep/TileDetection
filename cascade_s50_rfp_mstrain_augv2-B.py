...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=(1333, 800), #[(1300, 1300), (1500, 1500), (1700, 1700)],
...
optimizer = dict(type='Adam', lr=4.375e-06)
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=500,
...
load_from = None
resume_from = None
work_dir = '/root/neu-lab/TileDetection/work_dirs/round2/cascade_s50_rfp_mstrain_aug_alldata_v2-B'
workflow = [('train', 1)]
